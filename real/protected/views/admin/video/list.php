    ...
    <div class="modal-dialog">
        <div class='modal-content'>
            ...
            <div class="modal-body text-center">
                <form action="">
                    <h1 class="hidden">3</h1><h3 class="hidden">2</h3><h2 class="hidden">1</h2>
                    ...
                    <div class="input-group" style="margin-bottom:20px">
                        ...
                        <input type="text" class="form-control" placeholder="Username" aria-describedby="basic-addon3" value="asdfa@163.com">
                    </div>
                    <div class="input-group" style="margin-bottom:40px">
                        <span class="input-group-addon" id="basic-addon3">屏蔽次数</span>
                        <input type="text" class="form-control" placeholder="Username" aria-describedby="basic-addon3" value="3">
                    </div>
                    <div class="input-group" style="margin-bottom:20px">
            ...
            <div class="modal-body text-center">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group" style="padding-top:15px">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control"><a class="look-link" style="display:block;text-align:left" href="">未找到链接</a></p>
                        </div>
                    </div>
                    <div class="form-group" style="padding-top:15px">
                                ...
                                column_str +='<tr data-selfid='+data.result.data[key]['id']+' data-selfpid='+data.result.data[key]['product_id']+'>'+
                                    ...
                                    ' <button class="btn btn-success btn-bak">备份</button>'
                                        if(data.result.data[key]['status']=='已屏蔽'){
                                            column_str += ' <button  data-tel='+data.result.data[key]['tel']+' class="btn btn-default btn-life" >解除</button>'
                                        }else{
