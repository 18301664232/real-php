                        ...
                        <div class="query-box clearfix">
                            ...
                            <div class="select-area clearfix">
                                ...
                                <div class="select-date clearfix">
                                    <span class="rhDataConTabTimeSelect" id="rhDataConChannelTimeSelect"><input
                                                class="rhDataConTabTimeFrom Wdate input-one" type="text"
                                                onfocus="WdatePicker()" id="rhDataConChannelTimeFrom" size="20"
                                                value=""> - <input class="rhDataConTabTimeTo Wdate input-two"
                                                                   onfocus="WdatePicker()" id="rhDataConChannelTimeTo"
                                                                   size="20" value=""></span>
                                </div>
