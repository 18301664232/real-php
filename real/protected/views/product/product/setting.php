    ...
    <div class="modal-dialog rhOnlineSetModalDialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close colorbtn" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <ul id="myTab" class="nav nav-tabs">
                ...
                <li>
                    <a href="#L_tab4" data-toggle="tab">项目底色</a>
                </li>
            </ul>
            <div class="modal-body" id="L_phone_yz_bottombox6">
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade" id="L_tab4">
                        <div class="picker-box">
                            <div class="picker-left">
                                <div class="picker-background-color">

                                </div>
                            </div>
                            <div class="picker-right" id="picker-right">
                                <h4>设置加载前背景色</h4>
...
<script>
    $(function () {
        ...
        $('.colorbtn').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo U('product/product/SaveColor') ?>',
                data: {
