...
abstract class EMongoDocument extends EMongoEmbeddedDocument
{
	...
	public function insert(array $attributes=null)
	{
		...
		if($this->beforeSave())
		{
		    ...
		    $id=$this->getMongoAutoId($this->getCollectionName()); //根据表名获取自增id modify by L.D.B 2013-7-5
			$rawData['id']=$id;
