...
return array(
	...
	'components'=>array(
        ...
        'authManager'=>array(
            ...
            'itemTable' => 'r_AuthItem',//认证项表名称
            'itemChildTable' => 'r_AuthItemChild',//认证项父子关系
            'assignmentTable' => 'r_AuthAssignment',//认证项赋权关系
        ),
		...
		'db'=>array(
			'class'=>'CDbConnection',
			'connectionString' => 'mysql:host=127.0.0.1;dbname=real',
			'emulatePrepare' => true,
			'username' =>'root',
			'password' => 'syl7250611',
			'charset' => 'utf8',
