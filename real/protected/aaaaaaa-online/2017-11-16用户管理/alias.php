...
define('REAL', 'http://www.realplus.cc');  
define('NODE', 'http://100.114.245.126:5081');  
//define('NODE', 'http://59.110.28.109:5081');  
//define('NODE', 'http://59.110.28.109:5080');  
define('WTEDITOR', 'http://www.realplus.cc/wteditor/wteditor.html');  
...
define('DOWNLOAD_MAC','http://www.realplus.cc/download/RealApp_mac.zip');
define('DOWNLOAD_PC','http://www.realplus.cc/download/RealApp_pc.zip');